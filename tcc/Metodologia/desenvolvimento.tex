...
A Figura~\ref{fig:architecture} ilustra a arquitetura de três camadas adotada no protótipo \collectorFlutter{}.

\begin{figure}[H]
  \centering
  % Substitua 'architecture_diagram' pelo nome do arquivo da figura
  \includegraphics[width=0.7\textwidth]{architecture_diagram}
  \caption{Arquitetura de três camadas do protótipo \collectorFlutter{}: Data (coleta), Domain (análise) e Presentation (visualização).}
