...
\begin{itemize}
  ...
  \item \textbf{Power Monitor:} utilizado para medição indireta de consumo energético durante testes prolongados, apoiando a análise de eficiência do protótipo.
\end{itemize}
