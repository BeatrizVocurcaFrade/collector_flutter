...
\begin{itemize}
  ...
  \item \textbf{Avaliar preliminarmente o impacto da coleta de métricas} sobre o desempenho da aplicação, observando sinais de \textit{overhead} durante execuções controladas;
  \item \textbf{Verificar a coerência dos dados coletados}, comparando-os de forma preliminar com sinais observados em ferramentas de referência como Android Profiler e Perfetto~\cite{android2024,aosp2024};
...
\begin{itemize}
  ...
  \item execução controlada do protótipo em ambiente Android;
  \item análise qualitativa dos resultados observados e comparação preliminar com ferramentas nativas de referência.
\end{itemize}
...
O ciclo contempla dois momentos do trabalho: (i) \textbf{TCC 1}, voltado à fundamentação e ao protótipo inicial; e (ii) \textbf{TCC 2}, voltado à consolidação do protótipo, aos testes funcionais e à análise qualitativa dos resultados.
...
A Figura~\ref{fig:metodologia-pesquisa} sintetiza a estratégia metodológica adotada no trabalho, articulando fundamentação teórica, levantamento de requisitos, construção do protótipo e validação funcional. Essa organização evidencia que a avaliação realizada nesta versão tem caráter qualitativo e funcional, sem protocolo estatístico formal ou questionário externo de usabilidade.

\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\textwidth]{metodologia_pesquisa.png}
  \caption{Estratégia metodológica da pesquisa, com foco em revisão bibliográfica, requisitos, implementação e validação funcional do protótipo.}
...
\textbf{Objetivo:} validar funcionalmente o protótipo, observando se as métricas coletadas e as recomendações geradas são coerentes com os gargalos induzidos em cenários controlados.  
\textbf{Atividades:} definição dos cenários experimentais, execução manual controlada, coleta automatizada de telemetria, inspeção dos resultados e comparação preliminar com ferramentas oficiais.  
\textbf{Artefatos/saídas:} (i) registros de telemetria em JSON, (ii) tabela de cenários, (iii) evidências visuais do painel, (iv) discussão de resultados e limitações.  
\textbf{Critério de conclusão:} evidências suficientes para demonstrar a operacionalidade do protótipo e a pertinência das heurísticas implementadas.
