...
\begin{itemize}
  ...
  \item \textbf{Mensurar a precisão dos dados coletados}, comparando-os às medições obtidas por ferramentas oficiais como Android Profiler, Perfetto e Xcode Instruments~\cite{android2024,aosp2024,apple2024};
...
Estudos empíricos recentes sobre desempenho móvel reforçam que tempo de execução, memória e energia devem ser avaliados de forma conjunta, pois cada indicador pode reagir de modo distinto às mudanças realizadas no software~\cite{rua2024largescale}. Por isso, a análise experimental é essencial para associar métricas quantitativas a efeitos percebidos pelo usuário final.
