...
Semanas 7–9 (14 abr–02 mai) & Execução dos Testes Experimentais & Realização de testes controlados no protótipo, observando CPU, memória, rede e sinais de desempenho. Comparação preliminar com ferramentas de referência como Android Profiler e \textit{Perfetto}. \\
\hline

Semanas 10–12 (05–23 mai) & Análise dos Resultados & Interpretação qualitativa dos dados coletados. Avaliação da coerência das métricas, do comportamento do painel e da pertinência das recomendações sugeridas pelo protótipo. \\
\hline
