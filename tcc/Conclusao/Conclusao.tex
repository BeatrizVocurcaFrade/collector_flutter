...
\begin{enumerate}
  ...
  \item \textbf{Suíte de testes automatizados:} cobertura de 48 testes unitários distribuídos em quatro arquivos, verificando cálculos internos, detecção de anomalias, geração de recomendações, serialização e comportamento de \textit{fallback} dos \textit{platform channels}.
