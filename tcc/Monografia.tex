...
% Caminho padrão das imagens compartilhadas pela monografia e pelos slides
...
\newcommand{\collectorFlutter}{\texttt{collector\_\allowbreak flutter}}
...
\pagenumbering{roman}
\input{Resumo/Resumo}
\input{TabelaConteudo/TabelaConteudo}
\input{ListaFiguras/ListaFiguras}
...
\appendix
\include{Apendices/cronogramas}
\include{Apendices/evidencias}
\include{Apendices/testes}
